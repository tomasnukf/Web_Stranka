...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>/assets/css/style.css?v=20260607-banner">
</head>
<body>
<header class="site-header">
    ...
    <nav class="main-nav" data-nav>
        ...
        <a href="<?= BASE_URL ?>/effects.php" class="<?= str_contains($currentPath, 'effects.php') ? 'active' : '' ?>">Efekty</a>
